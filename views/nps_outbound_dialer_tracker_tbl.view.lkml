view: nps_outbound_dialer_tracker_tbl {
  ...
  measure: total_outbound_to_nps_number_calls {
    type: count_distinct
    sql: case when (correspondencetype = "phone-call" and relevent_NPS_call is true)  then ${providersessionid} else null end ;;
  }

  measure: total_outbound_to_nps_number_calls_answered_call {
    type: count_distinct
    sql: case when (correspondencetype = "phone-call" and relevent_NPS_call is true and is_answered_call is true)  then ${providersessionid} else null end ;;
  }
