view: sales_by_agents_looker_try_tbl {
  sql_table_name: `omega-post-184817.Keshet.Sales_by_Agents_looker_try_tbl`
    ;;
  ...
  dimension_group: order_created_day {
    type: time
    timeframes: [
      raw,
      date,
  ...
  dimension: order_source_adj {
    type: string
    sql: ${TABLE}.order_source_adj ;;
  }
  ...
  dimension_group: order_updated_day {
    type: time
    timeframes: [
      raw,
      date,
  ...
  dimension: uk_chosen_delivery_date {
    type: string
